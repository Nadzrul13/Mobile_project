...
import 'package:klinik_shoes_project/module/categories_page/binding/deep_cleaning_binding.dart';
...
class AppRoutes {
  ...
  GetPage(
    name: deep_cleaning, // Perbaikan: Gunakan String dengan tanda kutip
    page: () => DeepCleaningView(),
    binding: DeepCleaningBinding(), // Pastikan ini merujuk ke binding
  ),
